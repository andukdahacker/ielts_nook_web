...
import { IconDotsVertical, IconEye, IconFilter, IconFolderRoot, IconReload, IconSearch } from '@tabler/icons-react';
...
function StudentAssignmentView() {
    ...
    const { data, status, error, refetch, isRefetching, fetchNextPage, isFetchingNextPage, hasNextPage } =
                                                        ...
                                                        <Menu.Dropdown>
                                                            ...
                                                            {(e.assignment.status == 'SUBMITTED' ||
                                                                ...
                                                                <Menu.Item
                                                                    ...
                                                                    onClick={() => {
                                                                        navigate(`/assignment/${e.assignment.id}/view`);
                                                                    }}
                                                                >
                                                                    View
                                                                </Menu.Item>
