...
function ReadingMultipleChoice({ task, index }: ReadingMultipleChoiceProps) {
    ...
    const editOptionContent = (questionIndex: number, optionIndex: number, content: string) => {
        const newQuestions = [...task.questions];
    ...
    const removeOption = (questionIndex: number, optionIndex: number) => {
        ...
        const isCorrectAnswer = options[optionIndex].value == newQuestions[questionIndex].correctAnswer;
    ...
    const onDragEndOption = (questionIndex: number, sourceIndex: number, destinationIndex: number) => {
        const newQuestions = [...task.questions];
                                                ...
                                                <Stack ml={'xl'} justify="center">
                                                    <DragDropContext
                                                        onDragEnd={result => {
                                                            ...
                                                            if (destination != undefined) {
                                                                onDragEndOption(questionIndex, source, destination);
                                                            }
                                                        }}
                                                    >
                                                        <Droppable droppableId={`question${questionIndex}option`}>
                                                            {provided => (
                                                                <div
